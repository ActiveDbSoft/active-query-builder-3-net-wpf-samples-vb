...
End Sub))
		...
		Dim value As Boolean = CBool(args.NewValue)
		Dim obj As PaginationPanel = TryCast(o, PaginationPanel)
		...
		obj.PanelOffset.Visibility = If(CBool(args.NewValue), Visibility.Visible, Visibility.Collapsed)
...
End Function))
        ...
        Public Shared ReadOnly Property CurrentPageProperty As DependencyProperty = DependencyProperty.Register("CurrentPage", GetType(Integer), GetType(PaginationPanel), New PropertyMetadata(1, Function(o, args)
            Dim obj As PaginationPanel = TryCast(o, PaginationPanel)
            If obj IsNot Nothing Then
