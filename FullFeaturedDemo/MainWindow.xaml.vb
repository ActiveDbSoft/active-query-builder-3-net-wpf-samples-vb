...
Partial Public Class MainWindow
		...
		Private Shared Sub SqlQuery_QueryAwake(ByVal sender As QueryRoot, ByRef abort As Boolean)
		...
		Private Sub SqlQuery_SleepModeChanged(ByVal sender As Object, ByVal e As EventArgs)
...
'INSTANT VB NOTE: The variable language was renamed since Visual Basic does not handle local variables named the same as class members well:
		...
		Private Sub QueryTransformer_SQLUpdated(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub MenuItemQueryStatistics_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			ShowQueryStatistics()
		End Sub
		...
		Private Sub CommandOpen_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			' open a saved query
...
'ORIGINAL LINE: while ((s = sr.ReadLine()) != null)
		...
		Private Sub CommandSave_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			SaveInFile()
		End Sub

		Private Sub CommandExit_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			Close()
		End Sub

		Private Sub CommandNew_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
		...
		Private Sub CommandUndo_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.Undo()
		End Sub

		Private Sub CommandRedo_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.Redo()
		End Sub

		Private Sub CommandCopy_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.Copy()
		End Sub

		Private Sub CommandPaste_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.Paste()
		End Sub

		Private Sub CommandCut_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.Cut()
		End Sub

		Private Sub CommandSelectAll_OnExecuted(ByVal sender As Object, ByVal e As ExecutedRoutedEventArgs)
			BoxSql.SelectAll()
		End Sub

		Private Sub MenuItemQueryAddDerived_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			AddDerivedTable()
		End Sub
		...
		Private Sub MenuItemCopyUnionSq_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			CopyUnionSubQuery()
		End Sub
		...
		Private Sub MenuItemAddUnionSq_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			AddUnionSubQuery()
		End Sub
		...
		Private Sub MenuItemProp_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			PropertiesQuery()
		End Sub
		...
		Private Sub MenuItemAddObject_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			AddObject()
		End Sub
		...
		Private Sub MenuItemProperties_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Dim propWindow = New QueryBuilderPropertiesWindow(QBuilder)
			propWindow.ShowDialog()
		End Sub

		Private Sub LanguageMenuItemChecked(ByVal sender As Object, ByVal e As RoutedEventArgs)
			e.Handled = True
		...
		Private Sub MenuItem_OfflineMode_OnChecked(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Dim menuItem = DirectCast(sender, MenuItem)
		...
		Private Sub MenuItem_RefreshMetadata_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
		...
		Private Sub MenuItem_ClearMetadata_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			QBuilder.MetadataContainer.Clear()
		End Sub

		Private Sub MenuItem_LoadMetadata_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
		...
		Private Sub MenuItem_SaveMetadata_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
		...
		Private Sub MenuItem_About_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
		...
		Private Sub BoxSql_OnLostKeyboardFocus(ByVal sender As Object, ByVal e As KeyboardFocusChangedEventArgs)
			Try
		...
		Private Sub QBuilder_OnSQLUpdated(ByVal sender As Object, ByVal e As EventArgs)
		...
		Private Sub TimerStartingExecuteSql_Elapsed(ByVal state As Object)
			Dispatcher.BeginInvoke(CType(AddressOf FillFastResult, Action))
		End Sub

		Private Sub TabControl_OnSelectionChanged(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
		...
		Private Sub BoxSql_OnTextChanged(ByVal sender As Object, ByVal e As TextChangedEventArgs)
			ErrorBox.Show(Nothing, QBuilder.SyntaxProvider)
		End Sub

		Private Sub QBuilder_OnActiveUnionSubQueryChanged(ByVal sender As Object, ByVal e As EventArgs)
			SetSqlTextCurrentSubQuery()
		End Sub
		...
		Private Sub TabControlSql_OnSelectionChanged(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
		...
		Private Sub ButtonRefreshFastResult_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			FillFastResult()
		End Sub

		Private Sub CheckBoxAutoRefresh_OnChecked(ByVal sender As Object, ByVal e As RoutedEventArgs)
		...
		Private Sub BoxSqlCurrentSubQuery_OnLostKeyboardFocus(ByVal sender As Object, ByVal e As KeyboardFocusChangedEventArgs)
			If QBuilder.ActiveUnionSubQuery Is Nothing Then
				Return
			End If
			Try
		...
		Private Sub MenuItemUserExpression_OnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Dim window = New EditUserExpressionWindow With {
				.Owner = Me,
				.WindowStartupLocation = WindowStartupLocation.CenterOwner
			}
			window.Load(QBuilder.SyntaxProvider)
			window.ShowDialog()
		End Sub
	End Class
