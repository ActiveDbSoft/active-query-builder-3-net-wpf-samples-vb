...
Imports AutoGeneratedProperties.Tabs
...
Namespace AutoGeneratedProperties
	...
	Partial Public Class QueryPropertiesWindow
		Private ReadOnly _linkToPageGeneral As New Dictionary(Of TextBlock, Grid)()
		Private ReadOnly _linkToPageFormatting As New Dictionary(Of TextBlock, UserControl)()
