...
Namespace MdiControl.Converters
	Public Class MaximizeButtonTemplateSelector
		...
		Public Overrides Function SelectTemplate(item As Object, container As DependencyObject) As DataTemplate
            Dim obj As FrameworkElement = TryCast(container, FrameworkElement)
            If item IsNot Nothing Then
                Dim state As StateWindow = CType(item, StateWindow)
                Dim mdi As MdiChildWindow = FindParent(Of MdiChildWindow)(obj)
		...
		Private Shared Function FindParent(Of T As Class)(from As DependencyObject) As T
			...
			ElseIf parent IsNot Nothing Then
                result = FindParent(Of T)(CType(parent, DependencyObject))
            End If
