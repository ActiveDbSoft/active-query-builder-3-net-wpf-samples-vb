	...
	Partial Public Class OLEDBConnectionFrame
		...
		Private Sub BtnBuild_OnClick(sender As Object, e As RoutedEventArgs)
			...
			Try
				...
				Dim adodbConnection = New ADODB.Connection With {.ConnectionString = _connectionString}
			...
			Catch exception As Exception
				MessageBox.Show("Failed to show OLEDB Data Link Properties dialog box." & ControlChars.Lf & "Perhaps you have no required components installed or they are outdated." & ControlChars.Lf & "Try to rebuild this demo from the source code." & ControlChars.Lf & ControlChars.Lf & exception.Message)
			End Try
		End Sub
		...
		Private Sub btnTest_Click(sender As Object, e As RoutedEventArgs)
			Dim metadataProvider = New OLEDBMetadataProvider With {.Connection = New OleDbConnection(ConnectionString)}
