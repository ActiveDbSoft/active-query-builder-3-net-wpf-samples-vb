...
'INSTANT VB NOTE: The variable name was renamed since Visual Basic does not handle local variables named the same as class members well:
        ...
        Private Function SaveUserExpression() As Boolean
            ...
            Dim isChecked As Boolean? = CheckBoxIsNeedEdit.IsChecked
            Dim userExpression = New PredefinedCondition(TextBoxCaption.Text, listTypes, TextBoxExpression.Text, isChecked.HasValue AndAlso isChecked.Value = True)
        ...
        Protected Overrides Sub OnClosing(e As CancelEventArgs)
            If ButtonSave.IsEnabled Then
                Dim result = MessageBox.Show("Save changes to the current condition?", 
