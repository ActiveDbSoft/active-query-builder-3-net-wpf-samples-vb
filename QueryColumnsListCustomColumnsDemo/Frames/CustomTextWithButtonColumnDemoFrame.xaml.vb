	...
	Public Partial Class CustomTextWithButtonColumnDemoFrame
		...
		Private Sub QueryBuilder1_OnQueryElementControlCreated(owner As QueryElement, control As IQueryElementControl)
			If TypeOf control Is IQueryColumnListControl Then
				...
				textBox2.SetBinding(TextBox.TextProperty, New Binding("CustomData") With { _
				...
				Dim customColumn As DataGridTemplateColumn = New DataGridTemplateColumn() With { _
		...
		Private Sub dataGridView_CellEditEnding(sender As Object, e As DataGridCellEditEndingEventArgs)
			...
			' get new value
			Dim item = TryCast(e.Row.Item, ActiveQueryBuilder.View.WPF.QueryView.QueryColumnListItem)
